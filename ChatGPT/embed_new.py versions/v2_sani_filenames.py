# Got it 👍 — we’ll keep your current embed_new.py flow (with Meilisearch connection, JSON caching, etc.) and only fix the id sanitization to avoid the invalid_document_id errors.
# Here’s the updated script with minimal changes:
