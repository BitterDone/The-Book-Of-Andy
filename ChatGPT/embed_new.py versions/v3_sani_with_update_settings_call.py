# Here’s your embed_new.py updated to include the index.update_settings call for the all-MiniLM-L6-v2 embedder before adding any documents. 
# I also adjusted the document IDs to use the sanitized safe_id consistently so Meilisearch accepts them:
import os
import json
import glob
import re
