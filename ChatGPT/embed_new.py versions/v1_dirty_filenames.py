# That's a significant change from the embed_new.py we've been creating so far. 
# Apply the sanitization change to the embed_new.py we already have:
...
try: client.get_index("transcripts") 
